  ...
  return (
    <div className="flex flex-col flex-1 gap-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 flex-1">
        {/* Tailored resume */}
        <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-200 shadow-sm p-5 flex flex-col gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-400 ml-auto">ATS-safe format · ready to paste</span>
          </div>
          <pre className="flex-1 text-xs text-gray-700 whitespace-pre-wrap font-mono leading-relaxed bg-gray-50 rounded-xl p-4 overflow-auto min-h-[400px]">
            {result.tailored}
          </pre>
        </div>
