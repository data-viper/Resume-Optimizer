      ...
      <main className="flex-1 max-w-2xl w-full mx-auto px-4 sm:px-6 py-8 flex flex-col gap-6">
        ...
        {editing && (
          <div className="bg-white rounded-2xl border border-indigo-200 shadow-sm p-5 flex flex-col gap-4">
            <h2 className="text-sm font-semibold text-gray-900">
              {editing.id ? "Edit Resume" : "Add New Resume"}
            </h2>
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                placeholder="e.g. Senior Engineer, ML Specialist, Full Stack"
        ...
        {resumes.length === 0 && !editing ? (
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-10 flex flex-col items-center gap-3 text-center">
            ...
            <p className="text-xs text-gray-400">Add your first resume to get started</p>
            ...
            {resumes.map((resume) => (
              <div key={resume.id}
                className={`bg-white rounded-2xl border shadow-sm p-4 flex items-center gap-4 transition-all ${
                  resume.isActive ? "border-indigo-200 ring-1 ring-indigo-100" : "border-gray-200"
                }`}>
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${
                  resume.isActive ? "bg-indigo-100" : "bg-gray-100"
                }`}>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {resume.isActive && (
                      <span className="shrink-0 px-2 py-0.5 text-xs font-semibold bg-indigo-600 text-white rounded-full">Active</span>
                    )}
                  </div>
